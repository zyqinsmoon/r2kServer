			...
			<div class="content">
				<div id="content-page">
					<div id="form-container" class="ui-widget" style="margin: 20px 0; width: 1000px">
						<form id="form-res-save" action="" method="post" enctype="multipart/form-data">
							<div class="field">
								<label class="field-label">
									<em style="color:red;">*&nbsp;</em>名称:
								</label>
								<input class="ui-input field-input" name="authRes.resName" id="resName" />
								<span class="ui-tips-error" id="error-res-name"></span>
							</div>
							<div class="field">
								<label class="field-label">
									<em style="color:red;">*&nbsp;</em>链接:
								</label>
								<input class="ui-input field-input" name="authRes.resUrl" id="resUrl" />
								<span class="ui-tips-error" id="error-res-url"></span>
							</div>
							<div class="field">
								<label class="field-label">
									<em style="color:red;">*&nbsp;</em>所属模块:
								</label>
								<select>
								</select>
