	...
	<div class="wrapper">
			...
			<div id="navLink">
				<s:if test="deviceId != null">
					<a href="/r2k/dev/show.do" target="_self"><s:text name="r2k.menu.device"></s:text></a> &gt; <a href="/r2k/pub/device.do?deviceId=${deviceId}&deviceName=${deviceName}&devType=${devType}" target="_self"><s:text name="r2k.menu.pub"></s:text>(${deviceName})</a>&gt; 添加文章栏目(${deviceName})
					</s:if>
					<s:else>
						<a href="/r2k/pub/${actionName}.do" target="_self"><s:text name="r2k.menu.pub"></s:text>(${devTypeName}) </a> &gt; 添加文章栏目(${devTypeName})
					</s:else>
				</div>
		<div class="content">
			<div id="content-page">
					<div id="xml-container" class="ui-widget"
						...
						<form id="form-col-save" action="/r2k/pub/saveArtCol.do" enctype="multipart/form-data" method="post" >
							<input type="hidden" name="column.parentId" value="${parentId}">
							<input type="hidden" name="column.type" value="11">
							<s:if test="(deviceId == null && devType != 'ORG') || deviceId != null">
							<input type="hidden" name="column.infoTemplate.id" id="colTemplate">
							</s:if>
							...
							<fieldset>
								...
								<div class="field">
									...
									<select id="template">
										<s:iterator value="infoTemplates" var="temp">
											<s:if test="homeName.replace('home','articlelist') == #temp.name">
								...
								<div class="field">
									...
									<textarea class="ui-input field-input" name="column.summary" rows="10" id="summary"></textarea>
