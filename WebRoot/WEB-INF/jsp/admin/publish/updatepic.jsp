	 ...
	 <%@ include file="/commons/header.jsp" %>
		<div class="wrapper">
			...
			<div id="navLink">
					...
					<a href="/r2k/dev/show.do" target="_self"><s:text name="r2k.menu.device"></s:text></a> &gt; <a href="/r2k/pub/device.do?deviceId=${deviceId}&deviceName=${deviceName}&devType=${devType}" target="_self"><s:text name="r2k.menu.pub"></s:text>(${deviceName})</a>&gt; 更新图片(${deviceName})
					</s:if>
					<s:else>
						<a href="/r2k/pub/${actionName}.do" target="_self"><s:text name="r2k.menu.pub"></s:text>(${devTypeName}) </a> &gt; 更新图片(${devTypeName})
					</s:else>
				</div>
		<div class="content">
			<div id="content-page">
					<div id="xml-container" class="ui-widget"
						...
						<form id="form-col-update" enctype="multipart/form-data" method="post" 
							action="/r2k/pub/updatePic.do">
							...
							<fieldset>
								<div class="field">
									...
									<input class="ui-input field-input" name="column.title" id="title" value="${column.title }"/>
								...
								<div class="field">
									...
									<input class="ui-input field-input" name="column.content" id="content" value="${column.content}" />
									<span class="ui-tips-error" id="error-title"></span>
								</div>
								<div class="field">
									<label class="field-label">
