	 ...
	 <%@ include file="/commons/header.jsp" %>
		<div class="wrapper">
			...
			<div id="navLink">
					...
					<a href="/r2k/dev/show.do" target="_self"><s:text name="r2k.menu.device"></s:text></a> &gt; <a href="/r2k/pub/device.do?deviceId=${deviceId}&deviceName=${deviceName}&devType=${devType}" target="_self"><s:text name="r2k.menu.pub"></s:text>(${deviceName})</a>&gt; 添加欢迎页(${deviceName})
					</s:if>
					<s:else>
						<a href="/r2k/pub/${actionName}.do" target="_self"><s:text name="r2k.menu.pub"></s:text>(${devTypeName}) </a> &gt; 添加欢迎页(${devTypeName})
					</s:else>
				</div>
			<div class="content">
			<div id="content-page">
				<div id="xml-container" class="ui-widget"
					...
					<form id="" action="/r2k/pub/saveWelcome1.do" method="post"
						enctype="multipart/form-data">
						<input type="hidden" name="column.parentId" value="0" />
						<input type="hidden" name="column.type" value="0" />
