...
public abstract class CryptoUtils {
	 ...
	 */
	public static byte[] hmacSha1(final String input, final byte[] keyBytes) {
		try {
	 ...
	 */
	public static String hmacSha1ToHex(final String input, final byte[] keyBytes) {
	 ...
	 * @see #hmacSha1(String, byte[])
	 */
	public static String hmacSha1ToBase64(final String input, final byte[] keyBytes) {
		byte[] macResult = hmacSha1(input, keyBytes);
	 ...
	 * @see #hmacSha1(String, byte[])
	 */
	public static String hmacSha1ToBase64UrlSafe(final String input, final byte[] keyBytes) {
		byte[] macResult = hmacSha1(input, keyBytes);
	 ...
	 * @param keyBytes 密钥
	 */
	public static boolean isHexMacValid(final String hexMac, final String input, final byte[] keyBytes) {
	 ...
	 * @param keyBytes 密钥
	 */
	public static boolean isBase64MacValid(final String base64Mac, final String input, final byte[] keyBytes) {
	 ...
	 */
	public static String desEncryptToHex(final String input, final byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合DES要求的密钥
	 */
	public static String desEncryptToBase64(final String input, final byte[] keyBytes) {
		byte[] encryptResult = des(input.getBytes(), keyBytes, Cipher.ENCRYPT_MODE);
	 ...
	 * @param keyBytes 符合DES要求的密钥
	 */
	public static String desDecryptFromHex(final String input, final byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合DES要求的密钥
	 */
	public static String desDecryptFromBase64(final String input, final byte[] keyBytes) {
	 ...
	 */
	private static byte[] des(final byte[] inputBytes, final byte[] keyBytes, final int mode) {
		try {
	 ...
	 */
	public static String aesEncryptToHex(final String input, final byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合AES要求的密钥
	 */
	public static String aesEncryptToBase64(final String input, final byte[] keyBytes) {
		byte[] encryptResult = aes(input.getBytes(), keyBytes, Cipher.ENCRYPT_MODE);
		return EncodeUtils.base64Encode(encryptResult);
	}
	 ...
	 * @param keyBytes 符合AES要求的密钥
	 */
	public static String aesDecryptFromHex(final String input, final byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合AES要求的密钥
	 */
	public static String aesDecryptFromBase64(final String input, final byte[] keyBytes) {
	 ...
	 * @param mode Cipher.ENCRYPT_MODE 或 Cipher.DECRYPT_MODE
	 */
	private static byte[] aes(final byte[] inputBytes, final byte[] keyBytes, final int mode) {
		try {
